...
const components: ComponentItem[] = [
	...
	},
	{
		name: 'aspect-ratio',
		title: 'Aspect Ratio',
		description: 'Maintain consistent width-to-height ratios for media',
		category: 'component',
	...
	},
	{
		name: 'breadcrumb',
		title: 'Breadcrumb',
		description: 'Hierarchical path navigation with ellipsis support',
		category: 'component',
	...
	},
	{
		name: 'button-group',
		title: 'Button Group',
		description: 'Visually connected groups of related buttons',
		category: 'component',
	...
	},
	{
		name: 'context-menu',
		title: 'Context Menu',
		description: 'Right-click contextual menus with checkboxes and submenus',
		category: 'component',
	...
	},
	{
		name: 'date-picker',
		title: 'Date Picker',
		description: 'Date and date range selection with calendar popover',
		category: 'component',
	...
	},
	{
		name: 'drawer',
		title: 'Drawer',
		description: 'Mobile-friendly bottom and side sheets with drag handle',
		category: 'component',
	...
	},
	{
		name: 'hover-card',
		title: 'Hover Card',
		description: 'Rich preview cards triggered on hover',
		category: 'component',
	...
	},
	{
		name: 'input-otp',
		title: 'Input OTP',
		description: 'One-time password and PIN code input with grouped slots',
		category: 'component',
	...
	},
	{
		name: 'kbd',
		title: 'Kbd',
		description: 'Styled keyboard key and shortcut display',
		category: 'component',
	...
	},
	{
		name: 'menubar',
		title: 'Menubar',
		description: 'Application-style horizontal menu bar with submenus',
		category: 'component',
	...
	},
	{
		name: 'resizable',
		title: 'Resizable',
		description: 'Drag-to-resize panel groups, horizontal and vertical',
		category: 'component',
	...
	},
	{
		name: 'scroll-area',
		title: 'Scroll Area',
		description: 'Cross-browser custom scrollbars for overflow content',
		category: 'component',
	...
	},
	{
		name: 'typography',
		title: 'Typography',
		description: 'Semantic text components: headings, body, blockquote, code, list',
		category: 'component',
	...
	},
	{
		...
		description: 'Multi-selection list with search and grouped options',
		category: 'block',
		path: '/docs/blocks/multi-select-list',
		tags: ['form', 'selection'],
	},
	{
		name: 'navigable-list',
	...
	},
	{
		name: 'wizard',
		title: 'Wizard',
		description: 'Step-by-step guided workflow with progress tracking',
		category: 'block',
		path: '/docs/blocks/wizard',
