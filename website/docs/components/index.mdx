...
BuildGrid UI provides **54 carefully crafted components** that form the foundation of modern React applications. Each component is designed with accessibility, performance, and developer experience in mind.
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
  ...
  <ComponentCard 
    ...
    href="/docs/components/adaptive-input"
    tags={['form', 'input']}
  />
  <ComponentCard 
    title="Date Picker" 
