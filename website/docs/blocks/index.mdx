...
BuildGrid UI provides **15 powerful blocks** - complex, composed components that solve specific use cases out of the box. These blocks combine multiple components to provide advanced functionality for common application patterns.
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
  ...
  <ComponentCard 
    ...
    href="/docs/blocks/multi-select-list"
    tags={['form', 'selection']}
  />
</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
  ...
  <ComponentCard 
    ...
    href="/docs/blocks/wizard"
    tags={['navigation', 'form', 'workflow']}
  />
</div>
